<x-wire-elements-pro::bootstrap.modal on-submit="save" :content-padding="false">
    ...
    <div class="modal-body">
        ...
        {{-- <x-adminlte-input-file name="file" label="Carica file" placeholder="{{ $file_placeolder }}" error-key="file" wire:model.lazy="file" />
        ...
        <x-adminlte-select name="import_type_id" label="Tipo di Import" error-key="import_type_id" wire:model.lazy="import_type_id"
