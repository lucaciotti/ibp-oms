<x-wire-elements-pro::bootstrap.modal onSubmit="confirm" :contentPadding="false">
    ...
    <x-slot name="buttons">
            ...
            <button type="button" class="btn btn-default" wire:click="$emit('modal.close')" data-dismiss="modal">{{ $prompt['cancel'] }}</button>
            <button type="submit" class="btn btn-primary">{{ $prompt['confirm'] }}</button>
            {{-- <button type="button" wire:click="$emit('modal.close')" class="btn btn-secondary" data-bs-dismiss="modal">{{ $prompt['cancel'] }}</button>
            <button type="submit" class="btn btn-primary">{{ $prompt['confirm'] }}</button> --}}
    </x-slot>
